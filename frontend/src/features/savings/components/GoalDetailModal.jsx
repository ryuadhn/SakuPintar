                ...
                <div className="ui-card-subtle p-4 flex flex-col gap-4">
                    <div className="flex justify-between items-center">
                            ...
                            <div className="w-12 h-12 bg-white rounded-xl flex justify-center items-center shadow-sm border border-slate-100 shrink-0">
                                <Icon className="h-6 w-6 text-emerald-800" strokeWidth={1.75} aria-hidden="true" />
                            </div>
                    ...
                    <div className="md:col-span-5 space-y-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3.5">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <Calendar className="absolute left-3.5 top-3 h-4 w-4 text-slate-400" aria-hidden="true" />
                                    <input
                                        id="goal-entry-date"
                                        type="date"
                                        value={date}
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    <FileText className="absolute left-3.5 top-3 h-4 w-4 text-slate-400" aria-hidden="true" />
                                    <input
                                        id="goal-entry-note"
                                        type="text"
