                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-2">
                        <button
                            ...
                            onClick={handleLogout}
                             className="ui-button-compact w-9 h-9 lg:w-auto lg:flex-1 flex items-center justify-center gap-1.5 p-2 lg:px-3 lg:py-1.5 rounded-md bg-slate-50 hover:bg-red-50 text-slate-500 hover:text-red-600 transition-colors shrink-0"
                            title="Keluar"
                        >
                                                ...
                                                <div className="flex gap-3 items-start">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        <div className="flex justify-between items-center mb-0.5">
                                                            ...
                                                            {notif.type === 'saving' && (
                                                                 <span className="text-[9px] font-medium px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-800 shrink-0">
                                                                    Target
                                                                </span>
                                                            )}
                                                        </div>
