    ...
    const projection = useMemo(() => {
        if (!simulationInputsValid) {
            return {
                ...
                feasibilityClass: 'text-slate-700 bg-slate-50 border-slate-200',
        ...
        let feasibilityDesc = '';
        let feasibilityClass = 'text-slate-700 bg-slate-50 border-slate-200';
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="ui-card-emphasis p-5 flex flex-col justify-between min-h-32 relative overflow-hidden">
                                <span className="text-xs font-medium text-emerald-200">Setoran bulanan wajib</span>
                                <div>
                            ...
                            <div className="ui-card p-5 flex flex-col justify-between min-h-32 relative overflow-hidden">
                                <span className="text-xs font-medium text-slate-500">Target disesuaikan inflasi</span>
                                <div>
                        ...
                        <div className={`ui-alert p-4 border ${projection.feasibilityClass} flex gap-3 items-start`}>
                            <FeasibilityIcon className="w-5 h-5 shrink-0 mt-0.5" />
