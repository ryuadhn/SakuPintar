...
export default function DashboardInsightCard({ income = 0, expense = 0, net = 0, transactionCount = 0 }) {
    ...
    return (
        <section className="ui-card flex items-start gap-3 p-4 sm:p-5" aria-labelledby="dashboard-insight-heading">
            <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${insight.iconClass}`}>
